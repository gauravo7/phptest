        ...
        <div class="container py-md-5 py-3">
            <div class="row w3home-ab-grids">
                ...
                <div class="w3ab-left-top col-lg-6 mt-lg-0 mt-4 pt-lg-0 pt-2">
                    <h6 class="title-subw3hny mb-1">We’re safe movers.</h6>
                    <h3 class="title-w3l mb-2">Fast and reliable shipping services</h3>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 mt-lg-5 mt-4">
                        <div class="grids-1 box-wrap">
                            ...
                            <h4><a href="#service" class="title-head mb-3">Transportation</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 mt-lg-5 mt-4">
                        <div class="grids-1 box-wrap">
                            ...
                            <h4><a href="#service" class="title-head mb-3">Live Monitoring</a></h4>
                            <p class="text-para">Lorem ipsum dolor sit amet, elit. Id ab commodi magnam. </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-lg-5 mt-4">
                        <div class="grids-1 box-wrap">
                            ...
                            <h4><a href="#service" class="title-head mb-3">Worldwide Service</a></h4>
                            <p class="text-para">Lorem ipsum dolor sit amet, elit. Id ab commodi magnam. </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container py-md-4">
            ...
            <div class="witemshny-grids row">
                <div class="col-md-3 col-6 product-incfhny mt-4">
                    ...
                    <h4 class="gdnhy-1 mt-lg-4 mt-3"><a href="#img">Road Freight</a>
                    </h4>
                ...
                <div class="col-md-3 col-6 product-incfhny mt-4">
                    ...
                    <h4 class="gdnhy-1 mt-lg-4 mt-3"><a href="#img">Air Shipping</a>
                    </h4>
                    <p class="mt-md-2">Lorem ipsum dolor sit amet, elit. Id ab commodi magnam.</p>
                </div>
                <div class="col-md-3 col-6 product-incfhny mt-4">
                    ...
                    <h4 class="gdnhy-1 mt-lg-4 mt-3"><a href="#img"> Logistic Service</a>
                    </h4>
                    <p class="mt-md-2">Lorem ipsum dolor sit amet, elit. Id ab commodi magnam.</p>
                </div>
                <div class="col-md-3 col-6 product-incfhny mt-4">
                    <div class="weitemshny-grid oposition-relative">
                        <a href="#img" class="d-block zoom"><img src="assets/images/g5.jpg" alt="" class="img-fluid news-image"></a>
                        <div class="witemshny-inf">
                        </div>
                    </div>
                    <h4 class="gdnhy-1 mt-lg-4 mt-3"><a href="#img">Ground Shipping</a>
                    </h4>
                    <p class="mt-md-2">Lorem ipsum dolor sit amet, elit. Id ab commodi magnam.</p>
                </div>
            ...
            <div class="w3l-md-btn mx-auto text-center mt-md-5 mt-4">
                <a href="services.html" class="btn btn-style btn-primary mt-4">More Services</a>
            </div>
        </div>
    </section>
    <!--//w3l-grids-->
            ...
            <div class="container py-md-4">
                <div class="right-side">
                    <div class="row footer-hny-grids sub-columns">
                        <div class="col-lg-4 sub-one-left pe-lg-5">
                            ...
                            <p class="footer-phny mt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ute dolor sit.</p>
                        ...
                        <div class="col-lg-8 sub-two-right">
                            <div class="row">
                                ...
                                <div class="col-lg-3 sub-two-right">
                                    <h6>More Info</h6>
                                    <ul>
                                        <li><a href="#planing"> Planning</a>
                                        </li>
                                        <li><a href="#processing">Expert Tips</a>
                                        </li>
                                        <li><a href="#research">Tips & Strategies</a>
                                        </li>
                                        <li><a href="#metal"> Easy Payment</a>
                                        </li>
                                        <li><a href="#delivery"> Fast Delivery</a>
                                        </li>
                ...
                <div class="below-section mt-lg-5 pt-lg-4">
                    <div class="copyright-footer">
                        <p class="copyright-column">© 2022 Transpolar.All rights reserved. Design by <a href="https://w3layouts.com/" target="_blank">
                                W3Layouts</a></p>
